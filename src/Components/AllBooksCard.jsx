...
function AllBooksCard({ Books }) {
    ...
    return (
        ...
        <div className="shadow-[0px_1px_1px_gray] md:shadow-[0px_2px_5px_black] md:rounded-4xl p-4 h-[500px] flex flex-col justify-between text-center">
            ...
            {/* <p>{Book.category}</p> */}
            <Link to={`/book/${Books._id}`} className='bg-green-600 text-white p-2 md:p-4 font-bold rounded-4xl text-xs md:text-[14px] transition-all duration-200 hover:shadow-[0px_2px_5px_black] hover:scale-105 cursor-pointer '>View More Details</Link>
        </div>
